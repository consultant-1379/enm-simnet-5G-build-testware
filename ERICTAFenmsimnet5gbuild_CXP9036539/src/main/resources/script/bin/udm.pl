...
#     JIRA        : NSS-27484
#
#     Description : Required features for CCDM nodes(CCSM,CCDM,CCRC,CCPC,SC,EDA).
#
#     Date        : 3rd Nov 2019
#
####################################################################################
...
local @sim3= split /5G/, $sim1[0];
local @sim4= split /5G/, $sim2[3];
...
local $NODENAME="5G${SIMNUM}${NODETYPE}";
